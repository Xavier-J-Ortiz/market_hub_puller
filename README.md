...
There is some rate limiting going on on the EVE API, currently set at [300 requests per minute](https://forums.eveonline.com/t/esi-market-history-endpoint/387151/45) . This puts a damper on using `requests-futures` `FutureSession(max_worker=50)`.
